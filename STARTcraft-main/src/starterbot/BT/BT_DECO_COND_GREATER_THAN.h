...
// Specific conditional decorator task implementing the following condition: "a value is greater than a constant threshold" 
...
// 
//--------------------
template <class T> class BT_DECO_COND_GREATER_THAN : public BT_DECO_CONDITION {
...
public:
    BT_DECO_COND_GREATER_THAN(std::string name, BT_NODE* parent,T threshold,T& valueRef,bool strictComparison);
