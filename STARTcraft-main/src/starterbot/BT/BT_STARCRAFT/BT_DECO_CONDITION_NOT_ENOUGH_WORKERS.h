...
// 
//--------------------
class BT_DECO_CONDITION_NOT_ENOUGH_WORKERS: public BT_DECO_CONDITION {
public:
    BT_DECO_CONDITION_NOT_ENOUGH_WORKERS(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughWorkers(void *data);
