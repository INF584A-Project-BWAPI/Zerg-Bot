...
// 
//--------------------
class BT_DECO_CONDITION_NOT_ENOUGH_WORKERS_FARMING_RESOURCES : public BT_DECO_CONDITION {
public:
    BT_DECO_CONDITION_NOT_ENOUGH_WORKERS_FARMING_RESOURCES(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughWorkersFarmingResources(void* data);
